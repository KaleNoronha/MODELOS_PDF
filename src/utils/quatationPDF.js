...
export const printPDF = () => {
        ...
        doc.setFont("Arial");
        doc.setFontSize(18);
        doc.text('Transportes Mr Logistik S.A.C', 65, 25);
        doc.setFontSize(10);
        doc.text('Nuestra experiencia en logistica garantiza que tus entregas sean eficientes y', 50, 40);
        doc.text('confiable.', 100, 45);
        ...
        let c=1;
        if(c<10) c="A-000"+c;
        else if(c<100)c="A-00"+c;
        else if(c<1000)c="A-0"+c;
        let conteo = [
            {content:'',styles:{cellWidth:150, fillColor:[255,255,255]}},
            {content:c,styles:{cellWidth:30,lineColor: [0, 0, 0],lineWidth: 0.1}}
        ];
        const titul0 = [
            'Ruc/DNI',
             'Cliente', 
